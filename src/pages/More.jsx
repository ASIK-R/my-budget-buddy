  ...
  return (
    <div className="p-responsive w-full max-w-full overflow-x-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="sm:hidden mt-16"></div>
        ...
        <div className="rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#076653]/10 to-[#076653]/5 p-3 sm:p-4 md:p-5 backdrop-blur-xl border border-[#076653]/20 dark:border-[#076653]/10 relative overflow-hidden shadow-lg">
          {/* Decorative Elements */}
          <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-[#076653]/5 rounded-full -translate-y-8 translate-x-8"></div>
          <div className="absolute bottom-0 left-0 w-12 h-12 sm:w-16 sm:h-16 bg-[#076653]/5 rounded-full translate-y-6 -translate-x-6"></div>
        ...
        {/* Info Note */}
        <div className="rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/30 dark:from-blue-900/30 dark:to-blue-800/20 p-2 sm:p-3 border border-blue-200/50 dark:border-blue-700/30 backdrop-blur-xl shadow-md">
          <div className="flex items-start gap-2">
            <Info size={14} className="text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0 sm:size-16" />
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-5 pb-16 sm:pb-20">
          {allFeatures.map((category) => {
            ...
            return (
              <div key={category.id} className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-white/40 to-gray-100/40 dark:from-gray-800/40 dark:to-gray-900/40 backdrop-blur-xl border border-white/50 dark:border-gray-700/50 shadow-md sm:shadow-lg overflow-hidden relative">
                {/* Liquid glass effect elements */}
                <div className="absolute top-0 right-0 w-12 h-12 sm:w-16 sm:h-16 bg-[#076653]/5 rounded-full -translate-y-6 sm:-translate-y-8 translate-x-6 sm:translate-x-8 blur-lg"></div>
                <div className="absolute bottom-0 left-0 w-8 h-8 sm:w-12 sm:h-12 bg-[#076653]/5 rounded-full translate-y-4 sm:translate-y-6 -translate-x-4 sm:-translate-x-6 blur-lg"></div>
                
                <div className="p-3 sm:p-4 md:p-5 relative z-10">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <div className="p-1.5 sm:p-2 rounded-md sm:rounded-lg bg-[#076653]/10 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 shadow-sm">
                    ...
                    {category.items.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className="flex flex-col items-center justify-center p-1.5 sm:p-2 md:p-3 rounded-md sm:rounded-lg md:rounded-xl bg-white/20 dark:bg-gray-800/20 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 hover:bg-white/30 dark:hover:bg-gray-800/30 transition-all duration-300 group shadow-sm hover:shadow md:hover:shadow-md hover:-translate-y-0.5 relative overflow-hidden min-h-[60px] sm:min-h-[80px]"
                        >
                          {/* Inner glow effect */}
                          <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent rounded-md sm:rounded-lg md:rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                          
                          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-md bg-gradient-to-br from-[#076653]/20 to-[#076653]/10 flex items-center justify-center text-[#076653] mb-1 group-hover:scale-110 transition-all duration-300 shadow-sm border border-white/20 backdrop-blur-lg relative z-10">
